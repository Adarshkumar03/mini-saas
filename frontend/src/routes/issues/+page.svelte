        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {#each issues as issue (issue.id)}
                ...
                >
                    ...
                    <p class="text-sm text-gray-600 mb-1">Status: <span class="font-medium text-blue-700">{issue.status}</span></p>
                    <p class="text-sm text-gray-600 mb-1">Severity: <span class="font-medium text-yellow-700">{issue.severity}</span></p>
                    <p class="text-sm text-gray-600 mb-1">Created by: <span class="font-medium text-gray-700">{issue.owner_id}</span></p>
